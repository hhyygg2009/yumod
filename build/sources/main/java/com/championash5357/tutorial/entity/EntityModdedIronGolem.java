...
import com.championash5357.tutorial.entity.ai.EntityAIModdedDefendVillage;
import com.championash5357.tutorial.entity.ai.EntityAIModdedLookAtVillager;
...
public class EntityModdedIronGolem extends EntityGolem
{
    protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.<Byte>createKey(EntityModdedIronGolem.class, DataSerializers.BYTE);
    ...
    public EntityModdedIronGolem(World worldIn)
    {
        super(worldIn);
        this.setSize(10.0F, 1.0F);
    }

    protected void initEntityAI()
    {
        this.tasks.addTask(1, new EntityAIAttackMelee(this, 5.0D, true));
        this.tasks.addTask(2, new EntityAIMoveTowardsTarget(this, 0.01D, 64.0F));
        this.tasks.addTask(3, new EntityAIMoveThroughVillage(this, 0.6D, true));
        this.tasks.addTask(4, new EntityAIMoveTowardsRestriction(this, 1.0D));
        this.tasks.addTask(5, new EntityAIModdedLookAtVillager(this));
        this.tasks.addTask(6, new EntityAIWanderAvoidWater(this, 0.6D));
        this.tasks.addTask(7, new EntityAIWatchClosest(this, EntityPlayer.class, 6.0F));
        this.tasks.addTask(8, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAIModdedDefendVillage(this));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityModdedIronGolem.class);
    }
    ...
    public boolean attackEntityAsMob(Entity entityIn)
    {
        ...
        boolean flag = entityIn.attackEntityFrom(DamageSource.causeThornsDamage(this), (float)(7 + this.rand.nextInt(15)));
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        {
            this.village.modifyPlayerReputation(this.attackingPlayer.getUniqueID(), +100);
        }
