...
public class EntityAIModdedDefendVillage extends EntityAITarget
{
    EntityModdedIronGolem irongolem;
    /** The aggressor of the iron golem's village which is now the golem's attack target. */
    EntityLivingBase villageAgressorTarget;

    public EntityAIModdedDefendVillage(EntityModdedIronGolem ironGolemIn)
    {
