...
public class ModelModdedIronGolem extends ModelBase
{
    ...
    public ModelModdedIronGolem()
    {
        this(0.0F);
    }

    public ModelModdedIronGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelModdedIronGolem(float p_i46362_1_, float p_i46362_2_)
    {
        int i = 128;
        int j = 128;
    ...
    {
        EntityModdedIronGolem entityirongolem = (EntityModdedIronGolem)entitylivingbaseIn;
