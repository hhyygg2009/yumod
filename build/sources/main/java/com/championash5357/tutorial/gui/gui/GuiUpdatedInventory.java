...
public class GuiUpdatedInventory extends InventoryEffectRenderer implements IRecipeShownListener
{
    ...
    private GuiButtonImage recipeButton, modConfig;
    ...
    public void initGui()
    {
        ...
        this.modConfig = new GuiButtonImage(11, this.guiLeft + 149, this.height / 2 - 22, 20, 18, 178, 0, 19, INVENTORY_BACKGROUND);
        this.buttonList.add(this.modConfig);
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.id == 10)
        {
            ...
            this.modConfig.setPosition(this.guiLeft + 149, this.height / 2 -22);
