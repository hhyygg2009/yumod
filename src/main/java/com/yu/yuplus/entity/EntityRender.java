...
public class EntityRender extends Render<RockSpawnerEntity>
{
    ...
    public static class Factory implements IRenderFactory<RockSpawnerEntity> {

        @Override
        public Render<? super RockSpawnerEntity> createRenderFor(RenderManager manager) {
            return new EntityRender(manager, Minecraft.getMinecraft().getRenderItem());
        }

    }

    public EntityRender(RenderManager renderManagerIn, RenderItem p_i46167_2_)
    {
    ...
    private int transformModelCount(RockSpawnerEntity itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, IBakedModel p_177077_9_)
    {
     ...
     */
    public void doRender(RockSpawnerEntity entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(RockSpawnerEntity entity)
    {
